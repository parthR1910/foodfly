...
class CustomerOrderDeliveryBoyDetail extends ConsumerWidget {
  ...
  const CustomerOrderDeliveryBoyDetail(
      {super.key, required this.deliveryBoyId});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return StreamBuilder<UserModel>(
      stream: FireStoreService.fireStoreService
          .getDeliveryBoyDataFireStore(deliveryBoyId: deliveryBoyId),
          ...
          return Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    appStringWatch.keyPhoneNo,
                    style: AppTextStyle.w4
                        .copyWith(fontSize: 16.sp, color: AppColors.kGrey),
                  ),
                  Text(
                    deliveryBoyData.phone!.substring(3) ?? "",
                    style: AppTextStyle.w4
                        .copyWith(fontSize: 16.sp, color: AppColors.kBlack),
                  )
                ],
              ...
              Text("Contact With delivery boy:",
                  style: AppTextStyle.w4
                      .copyWith(fontSize: 16.sp, color: AppColors.kPrimary)),
              Row(
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                        ...
                        onPressed: () {
                          Future.delayed(const Duration(milliseconds: 700),
                              () async {
                            await launchUrl(Uri(
                                scheme: 'tel', path: deliveryBoyData.phone));
                          });
                        },
                        icon: const Icon(
                          Icons.call,

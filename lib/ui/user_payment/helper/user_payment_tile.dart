...
class UserPaymentTile extends StatelessWidget {
  const UserPaymentTile({super.key, this.orderStatusColor, this.orderStatusText, this.foodData,this.textStyle,   this.quantity =1, this.remainTime, this.dateTime, this.iconWidget, this.paidStatus});
                  ...
                  Expanded(child: Column(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text("₹ ${totalPrice.toStringAsFixed(2)}",style: AppTextStyle.w5.copyWith(fontSize: 18.sp,color: AppColors.kLightGreen)),
                      ],
                    ),
                      SizedBox(height: 6.h,),
                      Row(

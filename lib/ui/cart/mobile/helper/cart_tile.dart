        ...
        child: Container(
          ...
          child: Column(
            children: [
                  ...
                  Expanded(child: Column(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text("\$ 400",style: AppTextStyle.w5.copyWith(fontSize: 20.sp,color: AppColors.kPrimary)),
                      ],
                    ),
                      SizedBox(height: 6.h,),
                      Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Image.asset(AppAssets.timerClockPng,height: 30,width: 30,),
                      ...
                      Row(
                        children: [
                          ...
                          Text("Order on way",style: AppTextStyle.w5.copyWith(fontSize: 12.sp,color: AppColors.kLightGreen)),
                        ],
                      ),
              ...
              Row(
                children: [
                  Expanded(child: CommonButton(child: Text("Track Order"), onTap: (){},padding: EdgeInsets.symmetric(vertical: 10.h,),)),
                ],
              )
            ],
          ),

...
context.pushNamed(AppRoutes.profile);
              ...
              child: const CircleAvatar(backgroundColor: Colors.black,child: Icon(Icons.person,color: Colors.white,),)),
        ),title: Text(AuthService.authService.auth.currentUser?.displayName??'',style: TextStyle(fontSize: 17.sp,fontWeight: FontWeight.w700),),),
        body:const Column(
          children: [
            TabBarWidget(),

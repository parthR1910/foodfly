...
import 'package:food_fly_delivery_partner/main.dart';
...
class NotificationService {
  ...
  static void onNotificationTap(RemoteMessage event) {
    MyApp.navigatorKey.currentState!.pushNamed(AppRoutes.notifications);
  }
  ...
  static Future<void> sendNotification(
      String fcm, String title, String body) async {
    // Define the headers
